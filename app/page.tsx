  ...
  return (
    <div className="container mx-auto p-4">
      <Card className="w-full max-w-md mx-auto">
        <CardHeader>
          <CardTitle>Consulta de Paciente</CardTitle>
        </CardHeader>
        <CardContent>
          ...
          {paciente && (
            <div className="mt-6 space-y-4">
              ...
              <p><strong>Nro Historia Clínica:</strong> {paciente.nroHistoriaClinica}</p>
              <p><strong>Nombre:</strong> {paciente.primerNombre} {paciente.segundoNombre || ""}</p>
